from toolchain.builder.generic_platform import *
from toolchain.builder.openfpgaloader import OpenFPGALoader
from toolchain.builder.gowin.platform import GowinPlatform
from toolchain.builder.gowin.gowin import GowinToolchain
...
if __name__ == "__main__":
    toolchain=GowinToolchain()
    toolchain.build(Platform(),None)